...
cordova.define("salesforce/util/bootstrap", function(require, exports, module) {
    ...
    var onDeviceReady = function() {
        logger.logToConsole("onDeviceReady called: Cordova is ready.");
               ...
               setTimeout(function(){cordova.exec(null, null, "SplashScreen", "hide", []);}, 250);
    ...
    var loginSuccess = function(oauthCredentials) {
        ...
        cordova.exec(null, null, "com.appirio.mobile.credentials","AMCredentials",[oauthCredentials.instanceUrl, startData.appStartUrl, oauthCredentials.accessToken]);
        var fullAppUrl;
        if (startData instanceof LocalAppStartData) {
        ...
        fullAppUrl = fullAppUrl.replace("mob_StudentHome", "mob_StudentHome%3fappVersion=1_2");
